...
public class QRcodeUtil {
	  ...
	  * 方法名：qrCodeEncode<br/>
	  * 创建人：ShenPei <br/>
	  * 时间：2017年11月9日-下午3:50:58 <br/>
	  * 手机:1564545646464<br/>
	  * @param encodeddata
	  * @return
	  * @throws IOException BufferedImage<br/>
	  * @exception <br/>
	  * @since  1.0.0<br/>
	  */
...
//      g.drawImage(img, 25, 55,60,50, null);  
    ...
    public static void main(String[] args) {  
        ...
        //如果放外网的图片地址：图片打开线显示
        //如果是连接，直接跳转到网页对应地址
        //String encodeddata = "如果是连接，直接跳转到网页对应地址";  
        //String encodeddata = "http://www.jianshu.com/p/908bd0f419d8";  
        String encodeddata = "http://localhost:8080/login";  
        try {  
